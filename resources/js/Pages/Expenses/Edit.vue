<template>
  <form class="container mx-auto p-4" @submit.prevent="update">
    <h1 class="title">Edytuj wydatek</h1>
    <section class="mt-8 flex flex-col justify-center md:grid md:grid-cols-6 gap-4">
      ...
      <div v-if="!expense.file" class="col-span-6">
        ...
        <div>
          <div v-if="form.file?.name" class="text-sm mt-1">
      ...
      <button type="submit" class="w-full btn-primary col-span-6 mt-4">Edytuj wydatek</button>
    </section>
  </form>
</template>
